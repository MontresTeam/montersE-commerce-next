...
const SuccessModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 p-4 flex justify-center items-center w-full h-full z-[1000] bg-[rgba(0,0,0,0.5)] overflow-auto">
      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
        {/* Close Icon */}
        <svg
          onClick={onClose}
          xmlns="http://www.w3.org/2000/svg"
          className="w-3.5 h-3.5 cursor-pointer shrink-0 fill-gray-400 hover:fill-red-500 absolute top-4 right-4"
        ...
        <div className="mt-8 text-center">
          ...
          <div className="mt-6">
            ...
            <p className="text-sm text-slate-500 leading-relaxed mt-3">
              Your review has been submitted. Thank you for sharing your
              feedback!
            </p>
          </div>
        </div>
        ...
        <button
          onClick={onClose}
          type="button"
          className="mt-8 px-5 py-2.5 cursor-pointer w-full rounded-lg text-white text-sm font-medium border-none outline-none bg-gray-800 hover:bg-gray-700"
        >
          Got it
        </button>
      </div>
